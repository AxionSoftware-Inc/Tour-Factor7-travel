          ...
          <div class="container mx-auto px-6 text-center">
            <div class="max-w-3xl mx-auto p-12 rounded-3xl border-2 border-dashed border-green-200 bg-green-50/30">
              ...
              <div class="flex flex-wrap justify-center gap-8 text-sm font-semibold text-green-800">
                <span class="flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span> STIR: 301234567</span>
                <span class="flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span> Litsenziya: №123-456 (Jarayonda)</span>
              </div>
            </div>
          </div>
        </section>
